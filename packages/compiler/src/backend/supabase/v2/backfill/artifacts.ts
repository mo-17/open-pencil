...
import { emitSupabaseBackfillReviewSQLV2 } from './sql'
...
export function emitSupabaseBackfillArtifactsV2(
  ...
  const migrationPlan = {
    ...
    executionContract: {
      ...
      highWaterSource: 'future-trusted-locked-live-read',
      ...
      writeBarrierInstalled: false,
      lockedHighWaterCaptureAvailable: false,
      runnerEmitted: false
    },
  ...
  const reviewManifest = {
    ...
    catalogChecks: {
      ...
      required: {
        entityMarker: true,
        cursorFieldMarker: true,
        targetFieldMarker: true,
        primaryKeyMarkerAndExactShape: true,
        rlsEnabledAndForced: true,
        identityGeneration: 'always',
        sequenceOwnership: 'identity-internal-dependency',
        sequenceIncrement: 1,
        sequenceCache: 1,
        sequenceCycle: false,
        ...
        targetPostgresType: migration.transform.expectedPostgresType,
        ...
        runtimeSequenceAndCursorMutationAuthority: 'independent-host-proof',
        liveObjectIdentityAndCatalogDigestRevalidatedPerBatch: 'trusted-host-proof',
        runtimeTablePolicyTriggerRuleFunctionAndAclAuthority: 'independent-host-proof',
    ...
    reviewSqlTemplate: {
      ...
      positionalParameters: {
        $1: 'captured-high-water-from-future-trusted-locked-read',
    ...
    requiredManualChecks: [
      ...
      'prove-table-backfill-write-hazards-absent',
      'prove-target-default-expression-and-enum-domain',
      ...
      'install-write-barrier-and-capture-high-water-under-a-trusted-lock',
      'inspect-sequence-and-cursor-mutation-authority-for-every-runtime-role',
      'bind-live-table-column-sequence-oids-and-catalog-digest-per-batch',
      'inspect-runtime-table-policy-trigger-rule-function-and-acl-authority',
