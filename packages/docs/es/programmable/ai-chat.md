---
title: Chat con AI
description: Asistente integrado con más de 50 herramientas seleccionadas para crear, modificar y analizar diseños.
---
...
Las más de 50 herramientas seleccionadas cubren lectura, creación, modificación, estructura, variables, vectores, análisis, descripción, generación de código e imágenes de stock. Cada llamada actúa sobre el editor activo y participa en su historial de deshacer cuando corresponde.
