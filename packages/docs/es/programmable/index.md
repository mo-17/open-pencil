...
El asistente integrado puede ejecutar más de 50 herramientas seleccionadas para tareas comunes del editor. Una instrucción puede cambiar las sombras de varios botones, crear un componente con variante oscura o exportar una animación. Las operaciones avanzadas siguen disponibles mediante MCP.

[Chat con AI →](./ai-chat)

## MCP

Claude Code, Cursor, Windsurf y otros clientes MCP pueden usar más de 140 operaciones de diseño y operaciones de documentos y archivos propias de MCP. El chat integrado usa deliberadamente un conjunto menor de más de 50 herramientas seleccionadas. El servidor admite stdio y HTTP y mantiene sesiones independientes.
