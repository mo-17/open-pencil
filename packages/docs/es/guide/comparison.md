...
OpenPencil incluye un [comando `eval`](/programmable/cli/scripting) que proporciona una API de Plugin compatible con Figma para scripting headless. Además, el chat integrado ofrece más de 50 herramientas seleccionadas y el servidor MCP más de 140 operaciones de diseño mediante stdio y HTTP. Penpot tiene sistema de plugins con ejecución sandboxed pero sin API de scripting headless ni integración MCP.
