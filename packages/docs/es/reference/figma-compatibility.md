...
| Herramientas de AI | 🟡 | Más de 50 herramientas integradas seleccionadas, referencias visuales, búsqueda web opcional de OpenRouter, ejecución de código alojada por OpenAI y más de 140 operaciones MCP; aún sin modelo de generación de imágenes con AI |
...
| Servidor MCP | ✅ | `@open-pencil/mcp` con stdio y HTTP; más de 140 operaciones de diseño y operaciones de documentos y archivos |
