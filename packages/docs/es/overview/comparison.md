...
El comando [`eval`](/programmable/cli/scripting) proporciona una API compatible con plugins de Figma para scripts sin interfaz, operaciones por lotes y pruebas automatizadas. El chat integrado ofrece más de 50 herramientas seleccionadas y el servidor MCP más de 140 operaciones de diseño mediante stdio y HTTP.
