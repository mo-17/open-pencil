...
<kbd>⌘</kbd><kbd>J</kbd> abre el asistente. Sus más de 50 herramientas seleccionadas crean formas, modifican estilos y disposiciones, trabajan con componentes y variables, ejecutan operaciones booleanas, analizan variables de diseño y exportan recursos. Admite Anthropic, OpenAI, Google AI, OpenRouter y extremos compatibles.
...
Claude Code, Cursor, Windsurf y otros clientes MCP pueden leer y modificar archivos `.fig` sin interfaz. El servidor ofrece más de 140 operaciones de diseño y operaciones de documentos y archivos mediante stdio y HTTP.
