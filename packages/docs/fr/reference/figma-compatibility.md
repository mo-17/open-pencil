...
| Outils AI | 🟡 | Plus de 50 outils intégrés sélectionnés, références visuelles, recherche web OpenRouter optionnelle, exécution de code hébergée par OpenAI et plus de 140 opérations MCP ; pas encore de modèle de génération d’images AI |
...
| Serveur MCP | ✅ | `@open-pencil/mcp` avec stdio et HTTP ; plus de 140 opérations de design et des opérations sur les documents et fichiers |
