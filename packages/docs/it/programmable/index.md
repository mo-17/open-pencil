...
L’assistente integrato esegue oltre 50 strumenti selezionati per le attività comuni dell’editor. Un’istruzione può modificare le ombre di più pulsanti, creare un componente con variante scura o esportare un’animazione. Le operazioni avanzate restano disponibili tramite MCP.

[Chat con AI →](./ai-chat)

## MCP

Claude Code, Cursor, Windsurf e altri client MCP possono usare oltre 140 operazioni di design e operazioni MCP su documenti e file. La chat integrata usa intenzionalmente un insieme più piccolo di oltre 50 strumenti selezionati. Il server supporta stdio e HTTP con sessioni indipendenti.
