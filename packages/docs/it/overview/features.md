...
Premi <kbd>⌘</kbd><kbd>J</kbd>. Gli oltre 50 strumenti selezionati creano forme, cambiano stili e disposizione, lavorano con componenti e variabili, eseguono operazioni booleane, analizzano token di design ed esportano risorse. Sono supportati Anthropic, OpenAI, Google AI, OpenRouter ed endpoint compatibili.
...
Claude Code, Cursor, Windsurf e altri client MCP possono leggere e modificare `.fig` senza interfaccia. Il server offre oltre 140 operazioni di design e operazioni su documenti e file tramite stdio e HTTP.
