...
Barra degli strumenti, livelli, pagine, proprietà, zoom, spostamento, righelli, sfondo, menu contestuale e scorciatoie principali sono disponibili. Gli strumenti AI includono oltre 50 strumenti integrati selezionati, riferimenti visivi, ricerca web OpenRouter opzionale, esecuzione di codice ospitata da OpenAI e oltre 140 operazioni MCP; manca ancora un modello AI per generare immagini. Guide trascinabili, palette dei comandi, ricerca globale, vista reticolare e passo di spostamento personalizzato mancano o sono parziali.
...
Collaborazione P2P, visualizzazione JSX, Tailwind, server MCP e CLI sono disponibili. Il server MCP fornisce tramite stdio e HTTP oltre 140 operazioni di design e operazioni su documenti e file. Commenti, Code Connect, ramificazioni e specifiche complete di consegna mancano.
