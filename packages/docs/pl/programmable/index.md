...
Wbudowany asystent używa ponad 50 wyselekcjonowanych narzędzi do typowych zadań edytora. Opisz zadanie zwykłym językiem, na przykład: „dodaj wszystkim przyciskom cień 16 px”, „utwórz komponent karty z wariantem ciemnym” albo „wyeksportuj tę animację”. Zaawansowane operacje pozostają dostępne przez MCP.
...
Claude Code, Cursor, Windsurf i inni klienci MCP mogą korzystać z ponad 140 operacji projektowych oraz operacji MCP na dokumentach i plikach. Wbudowany czat celowo używa mniejszego, wyselekcjonowanego zestawu ponad 50 narzędzi. Serwer obsługuje stdio i HTTP z sesjami.
