...
| Narzędzia AI | 🟡 | Ponad 50 wbudowanych narzędzi i ponad 140 operacji MCP; bez obrazów generowanych przez AI ani wyszukiwania AI jeszcze |
...
| Serwer MCP | ✅ | @open-pencil/mcp z transportami stdio + HTTP; ponad 140 operacji projektowych oraz operacje dokumentów/plików |
