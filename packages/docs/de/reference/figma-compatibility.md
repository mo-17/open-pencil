...
| AI-Werkzeuge | 🟡 | Mehr als 50 kuratierte integrierte Werkzeuge, visuelle Referenzen, optionale OpenRouter-Websuche, gehostete OpenAI-Codeausführung und mehr als 140 MCP-Designoperationen; noch kein AI-Bildmodell |
...
`eval`, P2P-Zusammenarbeit, JSX-Codeansicht, Tailwind-Export, MCP-Server und CLI sind verfügbar. Der MCP-Server stellt über stdio und HTTP mehr als 140 Designoperationen sowie Dokument- und Dateioperationen bereit. Kommentare, Code Connect, Verzweigung und vollständige Übergabespezifikationen fehlen.
