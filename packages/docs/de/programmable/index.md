...
Der integrierte Assistent kann einen kuratierten Satz von mehr als 50 Werkzeugen für häufige Editor-Aufgaben ausführen. Eine Anweisung kann beispielsweise Schatten mehrerer Schaltflächen ändern, eine Komponente mit dunkler Variante erstellen oder eine Animation exportieren. Erweiterte Operationen bleiben über MCP verfügbar.
...
Claude Code, Cursor, Windsurf und andere MCP-Clients können mehr als 140 Designoperationen sowie MCP-spezifische Dokument- und Dateioperationen verwenden. Der integrierte AI-Chat nutzt bewusst einen kleineren, kuratierten Satz von mehr als 50 Werkzeugen. Der Server unterstützt stdio und HTTP mit Sitzungen.
