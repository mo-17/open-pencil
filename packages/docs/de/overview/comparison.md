...
Der Befehl [`eval`](/programmable/cli/scripting) stellt eine Figma-kompatible Plugin API für Skripte ohne Oberfläche, Stapelvorgänge und automatisierte Tests bereit. Der integrierte Chat bietet mehr als 50 kuratierte Werkzeuge, der MCP-Server mehr als 140 Designoperationen über stdio und HTTP.
