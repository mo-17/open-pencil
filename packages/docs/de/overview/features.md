...
<kbd>⌘</kbd><kbd>J</kbd> öffnet den Assistenten. Der kuratierte Satz von mehr als 50 Werkzeugen erstellt Formen, ändert Stile und Anordnungen, bearbeitet Komponenten und Variablen, führt boolesche Operationen aus, analysiert Designtoken und exportiert Ressourcen. Unterstützt werden Anthropic, OpenAI, Google AI, OpenRouter und kompatible Endpunkte.
...
Claude Code, Cursor, Windsurf und andere MCP-Clients können `.fig`-Dateien ohne grafische Oberfläche lesen und verändern. Der Server bietet mehr als 140 Designoperationen sowie Dokument- und Dateioperationen über stdio und HTTP.
