...
| ИИ-инструменты | 🟡 | Более 50 встроенных инструментов и более 140 MCP-операций; нет генерации изображений ИИ и ИИ-поиска |
...
| MCP-сервер | ✅ | @open-pencil/mcp с транспортами stdio + HTTP; более 140 операций с дизайном и операции с документами/файлами |
