...
| Инструменты ИИ | 🟡 | Более 50 встроенных отобранных инструментов, визуальные референсы, опциональный веб-поиск OpenRouter, выполнение кода на стороне OpenAI и более 140 MCP-операций; пока нет ИИ-модели для генерации изображений |
...
| Сервер MCP | ✅ | `@open-pencil/mcp`, stdio и HTTP; более 140 операций с дизайном и операции с документами и файлами |
