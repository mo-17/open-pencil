/**
 * Deterministic Motion planning, sampling, projection, and continuous-driver primitives.
 * Authored schemas remain in scene-graph; playback lifecycle remains in motion-runtime.
 */
