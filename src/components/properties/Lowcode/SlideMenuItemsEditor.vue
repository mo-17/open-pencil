      ...
      >
        ...
        <label class="mb-1 block text-[9px] text-muted">
          ...
          <input
            ...
            class="mt-0.5 w-full rounded border border-border bg-surface px-1.5 py-1 text-[10px] text-input outline-none placeholder:text-input/60 focus:border-accent"
        ...
        <label class="block text-[9px] text-muted">
          ...
          <input
            ...
            spellcheck="false"
            class="mt-0.5 w-full rounded border border-border bg-surface px-1.5 py-1 font-mono text-[10px] text-input outline-none placeholder:text-input/60 focus:border-accent"
