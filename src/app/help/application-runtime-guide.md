...
| Schema Inspector says the credential is missing     | PAT was not saved or the app-local credential store is unavailable               | Save a Supabase personal access token; if storage still fails, check the app-data directory permissions |
