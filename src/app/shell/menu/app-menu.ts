...
export function useAppMenu() {
  ...
  const translatedMenuItemLabels: Partial<Record<string, keyof typeof menu.value>> = {
    ...
    'plugin.export.wechat-miniprogram': 'exportWechatMiniProgramProject',
    'plugin.export.taro': 'exportTaroProject',
    'plugin.export.uni-app': 'exportUniAppProject',
    'plugin.export.mpx': 'exportMpxProject',
    autosave: 'autosave',
    close: 'closeTab',
    copy: 'copy',
    cut: 'cut',
