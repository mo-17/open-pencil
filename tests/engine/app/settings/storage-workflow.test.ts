...
let originalProvider = activeStorageProviderID.value
beforeEach(() => {
  originalProvider = activeStorageProviderID.value
  activeStorageProviderID.value = S3_COMPATIBLE_STORAGE_PROVIDER_ID
})
afterEach(() => {
