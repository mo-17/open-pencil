...
describe('business module document installation', () => {
  test('adds every module with one shared login and account page, preserving authored nodes', async () => {
    ...
    expect(application?.httpApi?.browserClient).toEqual(fixture.application.httpApi?.browserClient)
